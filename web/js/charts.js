  ...
  renderP2Movement() {
    ...
    const option = {
      ...
      legend: {
        ...
        itemHeight: 8,
        itemGap: 18,
        textStyle: { fontSize: 10.5, color: '#475569', fontWeight: 600 },
        icon: 'circle',
      },
      grid: { left: '4%', right: '4%', top: '38px', bottom: '24px', containLabel: true },
      xAxis: {
        type: 'category',
        data: data.channels,
        axisLabel: { color: '#475569', fontWeight: 600, fontSize: 10.5 },
        axisLine: { lineStyle: { color: '#E2E8F0' } },
        axisTick: { show: false },
      },
      yAxis: {
