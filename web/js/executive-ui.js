...
(() => {
  ...
  function loadPowerBiTheme() {
    ...
    appendStylesheet('css/reference-fidelity-v4.css?v=4.1.0', 'data-vikoda-reference-fidelity');
    ...
    appendScript('js/reference-fidelity-v4.js?v=4.1.0', 'data-vikoda-reference-fidelity');
